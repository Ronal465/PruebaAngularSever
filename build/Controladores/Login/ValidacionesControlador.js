...
class ValidacionesControlador {
    ...
    GetListFuncionesTipoUsuario(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const consultaempleado = yield database_1.default.query('SELECT idFuncionTipoUsuario,Nombre FROM FuncionTipoUsuario WHERE idTipoUsuario= ?', [CorreoElectronico], function (err, result, fields) {
                if (err) {
                    throw err;
                }
                ;
